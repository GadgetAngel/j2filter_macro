...
class J2FiltrTemplateWrapper(TemplateWrapper):
...
class J2FiltrPrinterGCodeMacro(PrinterGCodeMacro):
    def __init__(self, config):
        PrinterGCodeMacro.__init__(self, config)
...
class J2FiltrGCodeMacro(GCodeMacro):
    def __init__(self, config):
